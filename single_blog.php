...
if ($data = mysqli_query($conn,$sel_que))
{
    ...
    ECHO "Succesfullr run";
//    echo "<script> alert('SuccessFully Run This Query');</script>";
}else{
...
if($recent_data = mysqli_query($conn,$select_recent))
{
    echo "Success...";
}
else{
							...
							<div class="col-md-4">
								<div class="widget-item">
									...
									<form method="get" id="blog-search" class="blog-search">
                                        ...
                                        <span style="margin-top: 8px" class="bg-dark">
